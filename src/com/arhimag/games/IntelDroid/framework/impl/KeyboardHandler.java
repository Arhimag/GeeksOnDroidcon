...
import com.arhimag.games.IntelDroid.framework.BackKeyListener;
import com.arhimag.games.IntelDroid.framework.Input.KeyEvent;
import com.arhimag.games.IntelDroid.framework.impl.Pool.PoolObjectFactory;
...
public class KeyboardHandler implements OnKeyListener
{
	...
	public boolean onKey(View v, int keyCode, android.view.KeyEvent event)
	{
		...
		synchronized( this)
		{
			...
			if ( keyCode == android.view.KeyEvent.KEYCODE_BACK && backKeyListener != null )
				return backKeyListener.backKeyEvent();
		}
		return false;
	}
